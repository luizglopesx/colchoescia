...
const posts = [
  { html: 'post1-espuma-ou-mola.html', feed: 'post1-feed.png', story: 'post1-story.png' },
  { html: 'post2-espuma.html', feed: 'post2-feed.png', story: 'post2-story.png' },
  { html: 'post3-mola.html', feed: 'post3-feed.png', story: 'post3-story.png' },
];
