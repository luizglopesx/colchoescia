...
const posts = [
  { html: 'post1-comece-hoje.html', feed: 'post1-feed.png', story: 'post1-story.png' },
  { html: 'post2-sem-complicacao.html', feed: 'post2-feed.png', story: 'post2-story.png' },
  { html: 'post3-cabe-no-mes.html', feed: 'post3-feed.png', story: 'post3-story.png' },
];
